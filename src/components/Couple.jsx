                ...
                <div className="row">
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info groom-info">
                            ...
                            <p className="mt-2 mt-lg-3">
                                Paternal Grand S/O Janab <strong>Syed Budhen Sahab</strong>(Late),{" "}
                            </p>

                            <p className="mt-1 mt-lg-2">
                                Maternal Grand S/O Janab <strong>Mehboob Khan Sahab</strong>(Late),{" "}Mysore Lancers Military
                            </p>
                            <p className="mt-1 mt-lg-2">Brother of Janab <strong>Syed Waseem Pasha. W</strong> (H.B.S. Hospital).</p>

                            {/* <p className="mt-1 mt-lg-2">
                                S/O Janab <strong>B. Khadar Sahab,</strong>{" "}
                            </p>
                            <p className="mt-1 mt-lg-2">APSRTC, Adoni.</p>
                            <p className="mt-1 mt-lg-2">H.No.: 8/214, Shalangi Katta Street,</p>
                    ...
                    <div className="col-lg-5" data-aos="fade-up">
                        ...
                        <div className="info bride-info">
                            ...
                            <p className="mt-2 mt-lg-3">
                                D/O Janab <strong>Inayathullah Khan & Mrs. Rizwna Begum,</strong>
                            </p>
                            <p className="mt-2 mt-lg-3">
                                Paternal Grand D/O Janab <strong>M. Subhan Khan Sahab</strong>(Late), Postal Department
                            </p>
                            <p className="mt-2 mt-lg-3">
                                Maternal Grand D/O Janab <strong>Ali Khan Sahab</strong>(Late).
                            </p>
                            {/* <p className="mt-1 mt-lg-2">
                                Grand D/O Janab{" "}
